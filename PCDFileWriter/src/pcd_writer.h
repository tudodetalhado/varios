...
HRESULT WriteAsciiPcdFile( const INuiFusionColorMesh* mesh, const std::string& file, const bool flip = true, const bool color = false )
{
    HRESULT ret = S_OK;
...
HRESULT WriteBinaryPcdFile( const INuiFusionColorMesh* mesh, const std::string& file, const bool flip = true, const bool color = false )
{
    HRESULT ret = S_OK;
...
HRESULT WriteAsciiPcdFile( const INuiFusionMesh* mesh, const std::string& file, const bool flip = true )
{
    HRESULT ret = S_OK;
...
HRESULT WriteBinaryPcdFile( const INuiFusionMesh* mesh, const std::string& file, const bool flip = true )
{
    HRESULT ret = S_OK;
