...
#if !defined(KINECT_04_EFFECTS_DIALOG_H)
#define KINECT_04_EFFECTS_DIALOG_H
...
namespace Kinect
{
	...
	class Dialog : public QDialog
	{
		...
		public slots:
			...
			void eventButtonCenter();

			void eventComboChange(int idx);
...
#endif //!defined(KINECT_04_EFFECTS_DIALOG_H)
