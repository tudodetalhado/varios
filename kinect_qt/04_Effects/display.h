...
#if !defined(KINECT_04_EFFECTS_DISPLAY_H)
#define KINECT_04_EFFECTS_DISPLAY_H
...
namespace Kinect
{
	...
	class Display : public QGLWidget
	{
		...
		public:
			...
			void ChangeEffect(Effects::Enum effect);
		...
		protected:
			...
			QGLShaderProgram* m_shader_blur;
			QGLShaderProgram* m_shader_edge;
			QGLShaderProgram* m_shader_grayscale;
			QGLShaderProgram* m_shader_sepia;
	};
}

#endif //!defined(KINECT_04_EFFECTS_DISPLAY_H)
