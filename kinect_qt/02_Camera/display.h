...
#if !defined(KINECT_02_MOVEMENT_DISPLAY_H)
#define KINECT_02_MOVEMENT_DISPLAY_H
...
namespace Kinect
{
	class Display : public QObject
	{
		...
		public:
			...
			void DrawDepth(const unsigned char* data);
...
#endif //!defined(KINECT_02_MOVEMENT_DISPLAY_H)
