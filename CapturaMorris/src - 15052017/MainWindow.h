...
public Q_SLOTS:
    ...
    void onKinectCallback(byte *buffer);
...
private:
    ...
    ItemArena *arena;
    QImage _qImage;
    BYTE*   _bufferColorKinect = nullptr;
    UINT16* _bufferDepthKinect = nullptr;
    UINT16* _bufferInfraKinect = nullptr;
